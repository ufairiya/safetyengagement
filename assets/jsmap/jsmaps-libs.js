    ...
    return function(t) {
        ...
        i = [r(2)], void 0 !== (n = function(t) {
            function e(r) {
                ...
                if (e.is(r, W)) return e._engine.create[A](e, r.splice(0, 3 + e.is(r[0], Y))).add(r);
            ...
            function r(t) {
                ...
                for (var i in t) t[k](i) && (e[i] = r(t[i]));
                return e
            }
            ...
            function n(t, e, r) {
                function n() {
                    var a = Array.prototype.slice.call(arguments, 0),
                        ...
                        o = n.cache = n.cache || {},
                        l = n.count = n.count || [];
                    return o[k](s) ? (i(l, s), r ? r(o[s]) : o[s]) : (l.length >= 1e3 && delete o[l.shift()], l.push(s), o[s] = t[A](e, a), r ? r(o[s]) : o[s])
                }
                return n
            }
            ...
            function h(t, e, r, i, n, a, s, o, h) {
                if (!(h < 0 || l(t, e, r, i, n, a, s, o) < h)) {
                    var u, c = .5,
                        f = 1 - c;
                    for (u = l(t, e, r, i, n, a, s, o, f); q(u - h) > .01;) c /= 2, u = l(t, e, r, i, n, a, s, o, f += (u < h ? 1 : -1) * c);
                    return f
                }
            }
                ...
                if (!(I(t, r) < D(n, s) || D(t, r) > I(n, s) || I(e, i) < D(a, o) || D(e, i) > I(a, o))) {
                    ...
                    if (u) {
                        var c = l / u,
                            ...
                            p = +c.toFixed(2),
                            d = +f.toFixed(2);
                        if (!(p < +D(t, r).toFixed(2) || p > +I(t, r).toFixed(2) || p < +D(n, s).toFixed(2) || p > +I(n, s).toFixed(2) || d < +D(e, i).toFixed(2) || d > +I(e, i).toFixed(2) || d < +D(a, o).toFixed(2) || d > +I(a, o).toFixed(2))) return {
                            x: c,
                            y: f
                        }
                    }
            ...
            function v(t, e) {
                ...
                if (this.ms = e, this.times = 1, t) {
                    for (var n in t) t[k](n) && (i[$(n)] = t[n], r.push($(n)));
                    r.sort(nt)
                }
            ...
            function x(r, i, n, a, s, o) {
                ...
                var l, h, u, c, f, d, v = r.ms,
                    ...
                    m = {};
                if (a)
                    for (w = 0, B = Kt.length; w < B; w++) {
                        var b = Kt[w];
                        if (b.el.id == i.id && b.anim == r) {
                            b.percent != n ? (Kt.splice(w, 1), u = 1) : h = b, i.attr(b.totalOrigin);
                            break
                        }
                    } else a = +y;
                ...
                if (l) {
                    if (h) h.initstatus = a, h.start = new Date - h.ms * a;
                        ...
                        for (var C in l)
                            if (l[k](C) && (K[k](C) || i.paper.customAttributes[k](C))) switch (x[C] = i.attr(C), null == x[C] && (x[C] = J[C]), y[C] = l[C], K[C]) {
                                case Y:
                                    m[C] = (y[C] - x[C]) / v;
                                    break;
                                case "colour":
                                ...
                                case "path":
                                    var A = Tt(x[C], y[C]),
                                        E = A[1];
                                    for (x[C] = A[0], m[C] = [], w = 0, B = x[C].length; w < B; w++) {
                                        m[C][w] = [0];
                                        for (var M = 1, N = x[C][w].length; M < N; M++) m[C][w][M] = (E[w][M] - x[C][w][M]) / v
                                    }
                                    break;
                                case "transform":
                                    var P = i._,
                                        F = zt(P[C], y[C]);
                                    if (F)
                                        for (x[C] = F.from, y[C] = F.to, m[C] = [], m[C].real = !0, w = 0, B = x[C].length; w < B; w++)
                                        ...
                                        x[C] = [R.a, R.b, R.c, R.d, R.e, R.f], Nt(j, y[C]), y[C] = j._.transform, m[C] = [(j.matrix.a - R.a) / v, (j.matrix.b - R.b) / v, (j.matrix.c - R.c) / v, (j.matrix.d - R.d) / v, (j.matrix.e - R.e) / v, (j.matrix.f - R.f) / v]
                                    }
                                    break;
                                case "csv":
                                    var I = L(l[C])[z](_),
                                    ...
                                    break;
                                default:
                                    for (I = [][T](l[C]), D = [][T](x[C]), m[C] = [], w = i.paper.customAttributes[C].length; w--;) m[C][w] = ((I[w] || 0) - (D[w] || 0)) / v
                            }
                            var q = l.easing,
                        ...
                        if (d = l.start || r.start || +new Date, b = {
                                ...
                                origin: i.attr(),
                                totalOrigin: s
                            }, Kt.push(b), a && !h && !u && (b.stop = !0, b.start = new Date - v * a, 1 == Kt.length)) return ee();
                        u && (b.start = new Date - b.ms * a), 1 == Kt.length && te(ee)
                    }
            ...
            var m, b, _ = /[, ]+/,
                ...
                L = String,
                z = "split",
                P = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel" [z](N),
                F = {
                    mousedown: "touchstart",
                    mousemove: "touchmove",
                    mouseup: "touchend"
                },
                R = L.prototype.toLowerCase,
                j = Math,
                I = j.max,
                D = j.min,
                q = j.abs,
                ...
                rt = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi,
                it = (e._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/, {}),
                nt = function(t, e) {
                    return $(t) - $(e)
                },
                at = function(t) {
            ...
            if (e._g = B, e.type = B.win.SVGAngle || B.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == e.type) {
                ...
                if (ct.innerHTML = '<v:shape adj="1"/>', ut = ct.firstChild, ut.style.behavior = "url(#default#VML)", !ut || "object" != typeof ut.adj) return e.type = M;
                ct = null
            }
            e.svg = !(e.vml = "VML" == e.type), e._Paper = S, e.fn = b = S.prototype = e.prototype, e._id = 0, e.is = function(t, e) {
                return e = R.call(e), "finite" == e ? !H[k](+t) : "array" == e ? t instanceof Array : "null" == e && null === t || e == typeof t && null !== t || "object" == e && t === Object(t) || "array" == e && Array.isArray && Array.isArray(t) || G.call(t).slice(8, -1).toLowerCase() == e
                ...
                if (i = e.is(i, "finite") ? i : 10, e.is(t, W)) {
                    for (var n = t.length; n--;)
                        if (q(t[n] - r) <= i) return t[n]
                } else {
                    var a = r % (t = +t);
                    if (a < i) return r - a;
            ...
            e.setWindow = function(r) {
                t("raphael.setWindow", e, B.win, r), B.win = r, B.doc = B.win.document, e._engine.initWin && e._engine.initWin(B.win)
            };
            var ft = function(t) {
                    if (e.vml) {
                        var r;
                        ...
                        s.title = "Raphaël Colour Picker", s.style.display = "none", B.doc.body.appendChild(s), ft = n(function(t) {
                            return s.style.color = t, B.doc.defaultView.getComputedStyle(s, M).getPropertyValue("color")
                        })
                    }
                    return ft(t)
                },
            ...
            e.color = function(t) {
                ...
                return e.is(t, "object") && "h" in t && "s" in t && "b" in t ? (r = e.hsb2rgb(t), t.r = r.r, t.g = r.g, t.b = r.b, t.hex = r.hex) : e.is(t, "object") && "h" in t && "s" in t && "l" in t ? (r = e.hsl2rgb(t), t.r = r.r, t.g = r.g, t.b = r.b, t.hex = r.hex) : (e.is(t, "string") && (t = e.getRGB(t)), e.is(t, "object") && "r" in t && "g" in t && "b" in t ? (r = e.rgb2hsl(t), t.h = r.h, t.s = r.s, t.l = r.l, r = e.rgb2hsb(t), t.v = r.b) : (t = {
                    hex: "none"
                }).r = t.g = t.b = t.h = t.s = t.v = t.l = -1), t.toString = gt, t
                ...
                var i, n, a, s;
                return a = I(t, e, r), s = a - D(t, e, r), i = 0 == s ? null : a == t ? (e - r) / s : a == e ? (r - t) / s + 2 : (t - e) / s + 4, i = (i + 360) % 6 * 60 / 360, n = 0 == s ? 0 : s / a, {
                    h: i,
                    s: n,
                    b: a,
                    toString: pt
                ...
                t = (r = vt(t, e, r))[0], e = r[1], r = r[2];
                var i, n, a, s, o, l;
                return s = I(t, e, r), o = D(t, e, r), l = s - o, i = 0 == l ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4, i = (i + 360) % 6 * 60 / 360, a = (s + o) / 2, n = 0 == l ? 0 : a < .5 ? l / (2 * a) : l / (2 - 2 * a), {
                    h: i,
                    s: n,
                    l: a,
                    toString: dt
            ...
            e._preload = function(t, e) {
                ...
                }, B.doc.body.appendChild(r), r.src = t
            };
            e.getRGB = n(function(t) {
                ...
                return h ? (h[2] && (n = Z(h[2].substring(5), 16), i = Z(h[2].substring(3, 5), 16), r = Z(h[2].substring(1, 3), 16)), h[3] && (n = Z((o = h[3].charAt(3)) + o, 16), i = Z((o = h[3].charAt(2)) + o, 16), r = Z((o = h[3].charAt(1)) + o, 16)), h[4] && (l = h[4][z](tt), r = $(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = $(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = $(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), "rgba" == h[1].toLowerCase().slice(0, 4) && (s = $(l[3])), l[3] && "%" == l[3].slice(-1) && (s /= 100)), h[5] ? (l = h[5][z](tt), r = $(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = $(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = $(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), ("deg" == l[0].slice(-3) || "°" == l[0].slice(-1)) && (r /= 360), "hsba" == h[1].toLowerCase().slice(0, 4) && (s = $(l[3])), l[3] && "%" == l[3].slice(-1) && (s /= 100), e.hsb2rgb(r, i, n, s)) : h[6] ? (l = h[6][z](tt), r = $(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = $(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = $(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), ("deg" == l[0].slice(-3) || "°" == l[0].slice(-1)) && (r /= 360), "hsla" == h[1].toLowerCase().slice(0, 4) && (s = $(l[3])), l[3] && "%" == l[3].slice(-1) && (s /= 100), e.hsl2rgb(r, i, n, s)) : (h = {
                    r: r,
                    g: i,
                    b: n,
                    toString: a
                ...
                var i = {
                    ...
                    n = [];
                return e.is(t, W) && e.is(t[0], W) && (n = bt(t)), n.length || L(t).replace(/([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, function(t, e, r) {
                    var a = [],
                        s = e.toLowerCase();
                ...
                }), n.toString = e._path2string, r.arr = bt(n), n
            }, e.parseTransformString = n(function(t) {
                if (!t) return null;
                var r = [];
                return e.is(t, W) && e.is(t[0], W) && (r = bt(t)), r.length || L(t).replace(/([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, function(t, e, i) {
                    var n = [];
                    R.call(e);
            ...
            var mt = e.pathBBox = function(t) {
                ...
                _t = e._pathToRelative = function(t) {
                    ...
                    for (var h = l, u = t.length; h < u; h++) {
                        var c = i[h] = [],
                            f = t[h];
                        if (f[0] != R.call(f[0])) switch (c[0] = R.call(f[0]), c[0]) {
                            case "a":
                ...
                wt = e._pathToAbsolute = function(t) {
                    ...
                    for (var u, c, f = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), p = h, d = t.length; p < d; p++) {
                        if (i.push(u = []), (c = t[p])[0] != Q.call(c[0])) switch (u[0] = Q.call(c[0]), u[0]) {
                                case "A":
                                ...
                                case "H":
                                    ...
                                    break;
                                case "R":
                                    for (var g = [n, a][T](c.slice(1)), v = 2, x = g.length; v < x; v++) g[v] = +g[v] + n, g[++v] = +g[v] + a;
                                    i.pop(), i = i[T](s(g, f));
                                    break;
                                case "M":
                                    o = +c[1] + n, l = +c[2] + a;
                            ...
                            } else if ("R" == c[0]) g = [n, a][T](c.slice(1)), i.pop(), i = i[T](s(g, f)), u = ["R"][T](c.slice(-2));
                            else
                ...
                Ct = function(t, e, r, i, a, s, o, l, h, u) {
                    ...
                    if (u) B = u[0], C = u[1], w = u[2], k = u[3];
                        ...
                        j.cos(V / 180 * a), j.sin(V / 180 * a);
                        var v = (t - l) / 2,
                            x = (e - h) / 2,
                            y = v * v / (r * r) + x * x / (i * i);
                        y > 1 && (r *= y = j.sqrt(y), i *= y);
                        var m = r * r,
                            b = i * i,
                        ...
                        B = t < w ? V - B : B, C = l < w ? V - C : C, B < 0 && (B = 2 * V + B), C < 0 && (C = 2 * V + C), o && B > C && (B -= 2 * V), !o && C > B && (C -= 2 * V)
                    }
                    var S = C - B;
                    if (q(S) > f) {
                        var A = C,
                            E = l,
                            M = h;
                        C = B + f * (o && C > B ? 1 : -1), l = w + r * j.cos(C), h = k + i * j.sin(C), d = Ct(l, h, r, i, a, 0, o, E, M, [C, A, w, k])
                    }
                    S = C - B;
                    var N = j.cos(B),
                        L = j.sin(B),
                        ...
                        W = [l + I * F, h - D * P],
                        G = [l, h];
                    if (Y[0] = 2 * O[0] - Y[0], Y[1] = 2 * O[1] - Y[1], u) return [Y, W, G][T](d);
                    for (var H = [], X = 0, U = (d = [Y, W, G][T](d).join()[z](",")).length; X < U; X++) H[X] = X % 2 ? g(d[X - 1], d[X], p).y : g(d[X], d[X + 1], p).x;
                    return H
                },
                ...
                At = n(function(t, e, r, i, n, a, s, o) {
                    var l, h = n - 2 * r + t - (s - 2 * n + r),
                        ...
                        d = [e, o],
                        g = [t, s];
                    return q(f) > "1e12" && (f = .5), q(p) > "1e12" && (p = .5), f > 0 && f < 1 && (l = St(t, e, r, i, n, a, s, o, f), g.push(l.x), d.push(l.y)), p > 0 && p < 1 && (l = St(t, e, r, i, n, a, s, o, p), g.push(l.x), d.push(l.y)), h = a - 2 * i + e - (o - 2 * a + i), u = 2 * (i - e) - 2 * (a - i), c = e - i, f = (-u + j.sqrt(u * u - 4 * h * c)) / 2 / h, p = (-u - j.sqrt(u * u - 4 * h * c)) / 2 / h, q(f) > "1e12" && (f = .5), q(p) > "1e12" && (p = .5), f > 0 && f < 1 && (l = St(t, e, r, i, n, a, s, o, f), g.push(l.x), d.push(l.y)), p > 0 && p < 1 && (l = St(t, e, r, i, n, a, s, o, p), g.push(l.x), d.push(l.y)), {
                        min: {
                            x: D[A](0, g),
                            y: D[A](0, d)
                        },
                    ...
                    for (var i = wt(t), n = e && wt(e), a = {
                            ...
                            switch (!(t[0] in a) && (e.qx = e.qy = null), t[0]) {
                                ...
                                case "A":
                                    ...
                                    break;
                                case "S":
                                    "C" == r || "S" == r ? (i = 2 * e.x - e.bx, n = 2 * e.y - e.by) : (i = e.x, n = e.y), t = ["C", i, n][T](t.slice(1));
                                    break;
                                case "T":
                                    "Q" == r || "T" == r ? (e.qx = 2 * e.x - e.qx, e.qy = 2 * e.y - e.qy) : (e.qx = e.x, e.qy = e.y), t = ["C"][T](Bt(e.x, e.y, e.qx, e.qy, t[1], t[2]));
                                    break;
                                case "Q":
                                    e.qx = t[1], e.qy = t[2], t = ["C"][T](Bt(e.x, e.y, t[1], t[2], t[3], t[4]));
                                    break;
                                case "L":
                            ...
                            if (t[e].length > 7) {
                                t[e].shift();
                                for (var r = t[e]; r.length;) u[e] = "A", n && (c[e] = "A"), t.splice(e++, 0, ["C"][T](r.splice(0, 6)));
                                t.splice(e, 1), g = I(i.length, n && n.length || 0)
                            }
                        }, h = function(t, e, r, a, s) {
                            t && e && "M" == t[s][0] && "M" != e[s][0] && (e.splice(s, 0, ["M", a.x, a.y]), r.bx = 0, r.by = 0, r.x = t[s][1], r.y = t[s][2], g = I(i.length, n && n.length || 0))
                        ...
                        var v = i[d],
                            ...
                            y = v.length,
                            m = n && x.length;
                        a.x = v[y - 2], a.y = v[y - 1], a.bx = $(v[y - 4]) || a.x, a.by = $(v[y - 3]) || a.y, s.bx = n && ($(x[m - 4]) || s.x), s.by = n && ($(x[m - 3]) || s.y), s.x = n && x[m - 2], s.y = n && x[m - 1]
                    }
                ...
                Et = (e._parseDots = n(function(t) {
                    ...
                    for (i = 1, n = r.length - 1; i < n; i++)
                        if (!r[i].offset) {
                            ...
                            l || (l = 100, h = n);
                            for (var u = ((l = $(l)) - o) / (h - i + 1); i < h; i++) o += u, r[i].offset = o + "%"
                        }
                    return r
                ...
                Mt = (e._tofront = function(t, e) {
                    e.top !== t && (Et(t, e), t.next = null, t.prev = e.top, e.top.next = t, e.top = t)
                }, e._toback = function(t, e) {
                    e.bottom !== t && (Et(t, e), t.next = e.bottom, t.prev = null, e.bottom.prev = t, e.bottom = t)
                }, e._insertafter = function(t, e, r) {
                    Et(t, r), e == r.top && (r.top = t), e.next && (e.next.prev = t), t.next = e.next, t.prev = e, e.next = t
                }, e._insertbefore = function(t, e, r) {
                    Et(t, r), e == r.bottom && (r.bottom = t), e.prev && (e.prev.next = t), t.prev = e.prev, e.prev = t, t.next = e
                ...
                zt = e._equaliseTransform = function(t, r) {
                    r = L(r).replace(/\.{3}|\u2026/g, t), t = e.parseTransformString(t) || [], r = e.parseTransformString(r) || [];
                    for (var i, n, a, s, o = I(t.length, r.length), l = [], h = [], u = 0; u < o; u++) {
                        if (a = t[u] || Lt(r[u]), s = r[u] || Lt(a), a[0] != s[0] || "r" == a[0].toLowerCase() && (a[2] != s[2] || a[3] != s[3]) || "s" == a[0].toLowerCase() && (a[3] != s[3] || a[4] != s[4])) return;
            ...
            e._getContainer = function(t, r, i, n) {
                    var a;
                    if (null != (a = null != n || e.is(t, "object") ? t : B.doc.getElementById(t))) return a.tagName ? null == r ? {
                        container: a,
                ...
                }, e.pathToRelative = _t, e._engine = {}, e.path2curve = Tt, e.matrix = function(t, e, r, i, n, a) {
                ...
                function(t) {
                    ...
                    t.add = function(t, e, r, i, n, a) {
                        ...
                        t.scalex = j.sqrt(r(n[0])), i(n[0]), t.shear = n[0][0] * n[1][0] + n[0][1] * n[1][1], n[1] = [n[1][0] - n[0][0] * t.shear, n[1][1] - n[0][1] * t.shear], t.scaley = j.sqrt(r(n[1])), i(n[1]), t.shear /= t.scaley;
                        var a = -n[0][1],
                            s = n[1][1];
                        return s < 0 ? (t.rotate = e.deg(j.acos(s)), a < 0 && (t.rotate = 360 - t.rotate)) : t.rotate = e.deg(j.asin(a)), t.isSimple = !(+t.shear.toFixed(9) || t.scalex.toFixed(9) != t.scaley.toFixed(9) && t.rotate), t.isSuperSimple = !+t.shear.toFixed(9) && t.scalex.toFixed(9) == t.scaley.toFixed(9) && !t.rotate, t.noRotation = !+t.shear.toFixed(9) && !t.rotate, t
            ...
            for (var Pt = function() {
                    ...
                    return B.doc.addEventListener ? function(t, e, r, i) {
                        ...
                        if (t.addEventListener(e, n, !1), E && F[e]) {
                            var a = function(e) {
                        ...
                        return function() {
                            return t.removeEventListener(e, n, !1), E && F[e] && t.removeEventListener(F[e], a, !1), !0
                        }
                        ...
                        var n = function(t) {
                            ...
                            var e = B.doc.documentElement.scrollTop || B.doc.body.scrollTop,
                                ...
                                a = t.clientX + n,
                                s = t.clientY + e;
                            return t.preventDefault = t.preventDefault || Pt, t.stopPropagation = t.stopPropagation || Rt, r.call(i, t, a, s)
                        };
                    ...
                    for (var r, i = e.clientX, n = e.clientY, a = B.doc.documentElement.scrollTop || B.doc.body.scrollTop, s = B.doc.documentElement.scrollLeft || B.doc.body.scrollLeft, o = qt.length; o--;) {
                        ...
                        var u, c = r.el.node,
                            ...
                            p = c.parentNode,
                            d = c.style.display;
                        B.win.opera && p.removeChild(c), c.style.display = "none", u = r.el.paper.getElementByPoint(i, n), c.style.display = d, B.win.opera && (f ? p.insertBefore(c, f) : p.appendChild(c)), u && t("raphael.drag.over." + r.el.id, r.el, u), i += s, n += a, t("raphael.drag.move." + r.el.id, r.move_scope || r.el, i - r.el._drag.x, n - r.el._drag.y, i, n, e)
                    }
                }, Vt = function(r) {
                    ...
                    qt = []
                }, Yt = e.el = {}, Wt = P.length; Wt--;) ! function(t) {
            ...
            Yt.data = function(r, i) {
                ...
                if (1 == arguments.length) {
                    if (e.is(r, "object")) {
                        for (var a in r) r[k](a) && this.data(a, r[a]);
                        return this
                    }
                ...
                return null == t ? it[this.id] = {} : it[this.id] && delete it[this.id][t], this
            }, Yt.getData = function() {
                return r(it[this.id] || {})
            ...
            Yt.drag = function(r, i, n, a, s, o) {
                function l(l) {
                    ...
                    if (this._drag.id = l.identifier, E && l.touches)
                    ...
                    this._drag.x = h + f, this._drag.y = u + c, !qt.length && e.mousemove(Ot).mouseup(Vt), qt.push({
                        el: this,
                        move_scope: a,
                        start_scope: s,
                        end_scope: o
            ...
            b.getElementByPoint = function(t, e) {
                ...
                var e = this._;
                return t ? (!e.dirty && e.bboxwt || (this.realPath = lt[this.type](this), e.bboxwt = mt(this.realPath), e.bboxwt.toString = d, e.dirty = 0), e.bboxwt) : ((e.dirty || e.dirtyT || !e.bbox) && (!e.dirty && this.realPath || (e.bboxwt = 0, this.realPath = lt[this.type](this)), e.bbox = mt(ht(this.realPath, this.matrix)), e.bbox.toString = d, e.dirty = e.dirtyT = 0), e.bbox)
            }, Yt.clone = function() {
                        ...
                        for (var s, o, l, h, u, c = "", f = {}, p = 0, d = 0, g = (i = Tt(i)).length; d < g; d++) {
                            if ("M" == (l = i[d])[0]) s = +l[1], o = +l[2];
                                ...
                                if (h = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6]), p + h > n) {
                                    ...
                                    if (!t && !r) return u = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6], n - p), {
                                        x: u.x,
                                        y: u.y,
                                        alpha: u.alpha
                                    }
                    ...
                    for (var r = +new Date, i = 0; i < Kt.length; i++) {
                        ...
                        if (!n.el.removed && !n.paused) {
                            var a, s, o = r - n.start,
                                ...
                                d = {},
                                g = {};
                            if (n.initstatus ? (o = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * l, n.status = n.initstatus, delete n.initstatus, n.stop && Kt.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (o / l)) / n.anim.top, !(o < 0))
                                if (o < l) {
                                    var v = h(o / l);
                                    for (var y in u)
                                        if (u[k](y)) {
                                    ...
                                    if (function(r, i, n) {
                                        ...
                                        }(n.callback, p, n.anim), p.attr(f), Kt.splice(i--, 1), n.repeat > 1 && !n.next) {
                                        for (s in f) f[k](s) && (g[s] = n.totalOrigin[s]);
            ...
            Yt.animateWith = function(t, r, i, n, a, s) {
                ...
                var r, i, n = [],
                    a = 0;
                if (null != e) return x(t, this, -1, D(e, 1)), this;
                ...
                return this
            }, t.on("raphael.remove", y), t.on("raphael.clear", y), Yt.toString = function() {
                return "Raphaël’s object"
            };
            var ie = function(t) {
                    if (this.items = [], this.length = 0, this.type = "set", t)
                        for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != Yt.constructor && t[e].constructor != ie || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
                },
                ne = ie.prototype;
            ne.push = function() {
                for (var t, e, r = 0, i = arguments.length; r < i; r++) !(t = arguments[r]) || t.constructor != Yt.constructor && t.constructor != ie || (this[e = this.items.length] = this.items[e] = t, this.length++);
                return this
            }, ne.pop = function() {
            ...
            for (var ae in Yt) Yt[k](ae) && (ne[ae] = function(t) {
                return function() {
                    var e = arguments;
            ...
            return ne.attr = function(t, r) {
                    ...
                    t = t < 0 ? I(this.length + t, 0) : t, e = I(0, D(this.length - t, e));
                    var i, n = [],
                        a = [],
                        s = [];
                    ...
                    return t = D[A](0, t), e = D[A](0, e), r = I[A](0, r), i = I[A](0, i), {
                        x: t,
                        y: e,
                        x2: r,
                        y2: i,
                        ...
                        for (var n in t.glyphs)
                            if (t.glyphs[k](n)) {
                                ...
                                if (e.glyphs[n] = {
                                    ...
                                    for (var s in a.k) a[k](s) && (e.glyphs[n].k[s] = a.k[s])
                            }
                    }
                    return t
                    ...
                    s = s || "middle", o = I(D(o || 0, 1), -1), l = I(D(l || 1, 3), 1);
                    var h, u = L(i)[z](M),
                        c = 0,
                        f = 0,
                        p = M;
                    ...
                    if (e.is(t, "array"))
                        for (var r, i = this.set(), n = 0, a = t.length; n < a; n++) r = t[n] || {}, w[k](r.type) && i.push(this[r.type]().attr(r));
                    return i
                    ...
                    return e
                }, e.st = ne, t.on("raphael.DOMload", function() {
                    m = !0
                }),
                function(t, r, i) {
                    function n() {
        ...
        ! function(r) {
            ...
            eve = function(t, e) {
                var r, i = s,
                    ...
                    d = [],
                    g = a;
                d.firstDefined = c, d.lastDefined = f, a = t, s = 0;
                for (var v = 0, x = o.length; v < x; v++) "zIndex" in o[v] && (u.push(o[v].zIndex), o[v].zIndex < 0 && (p[o[v].zIndex] = o[v]));
                for (u.sort(h); u[l] < 0;)
                    if (r = p[u[l++]], d.push(r.apply(e, n)), s) return s = i, d;
                for (v = 0; v < x; v++)
                    if ("zIndex" in (r = o[v]))
                        if (r.zIndex == u[l]) {
                            if (d.push(r.apply(e, n)), s) break;
                            do {
                                if (l++, (r = p[u[l]]) && d.push(r.apply(e, n)), s) break
                            } while (r)
                        } else p[r.zIndex] = r;
                else if (d.push(r.apply(e, n)), s) break;
                return s = i, a = g, d
            }, eve._events = u, eve.listeners = function(t) {
                var e, r, i, n, a, s, o, h, c = g(t) ? t : t.split(l),
                    f = u,
                    p = [f],
                    d = [];
                ...
                t ? (t = "[" + (t = d(t).replace(/(?=[\.\^\]\[\-])/g, "\\")) + "]", l = new RegExp(t)) : l = /[\.\/]/
            }, eve.on = function(t, e) {
                if ("function" != typeof e) return function() {};
                for (var r = g(t) ? g(t[0]) ? t : [t] : d(t).split(/\s*,\s*/), i = 0, n = r.length; i < n; i++) ! function(t) {
                    for (var r, i = g(t) ? t : d(t).split(l), n = u, a = 0, s = i.length; a < s; a++) n = (n = n.n).hasOwnProperty(i[a]) && n[i[a]] || (n[i[a]] = {
                        n: {}
                    });
                ...
                if (!t) return void(eve._events = u = {
                    n: {}
                });
                ...
                if (r.length > 1)
                    ...
                    for (i = 0, n = r.length; i < n; i++)
                        for (c = 0; c < p.length; c += h.length - 2) {
                            if (h = [c, 1], a = p[c].n, "*" != r[i]) a[r[i]] && h.push(a[r[i]]);
                            else
                                for (s in a) a[o](s) && h.push(a[s]);
                            p.splice.apply(p, h)
                        }
        ...
        i = [r(1)], void 0 !== (n = function(t) {
            if (!t || t.svg) {
                ...
                var g = function(i, n) {
                    ...
                    v = function(e, n) {
                        ...
                        if (!m) {
                            ...
                            if (c = c.replace(/[\(\)\s,\xb0#]/g, "_"), e.gradient && c != e.gradient.id && (v.defs.removeChild(e.gradient), delete e.gradient), !e.gradient) {
                                ...
                                for (var B = 0, C = k.length; B < C; B++) m.appendChild(g("stop", {
                    ...
                    b = function(i, n, a) {
                        if ("path" == i.type) {
                            for (var s, o, l, h, c, f = r(n).toLowerCase().split("-"), v = i.paper, x = a ? "end" : "start", y = i.node, m = i.attrs, b = m["stroke-width"], _ = f.length, w = "classic", k = 3, B = 3, C = 5; _--;) switch (f[_]) {
                                case "block":
                                case "classic":
                                case "oval":
                                case "diamond":
                            ...
                            if ("open" == w ? (k += 2, B += 2, C += 2, l = 1, h = a ? 4 : 1, c = {
                                    fill: "none",
                                    stroke: m.stroke
                                }) : (h = l = k / 2, c = {
                                    fill: m.stroke,
                                ...
                                E ? (d[A]++, T = E.getElementsByTagName("use")[0]) : (E = g(g("marker"), {
                                    id: A,
                                    markerHeight: B,
                                    markerWidth: k,
                                    orient: "auto",
                                ...
                                }), E.appendChild(T), v.defs.appendChild(E), d[A] = 1), g(T, c);
                                var M = l * ("diamond" != w && "oval" != w);
                                a ? (s = i._.arrows.startdx * b || 0, o = t.getTotalLength(m.path) - M * b) : (s = M * b, o = t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0)), (c = {})["marker-" + x] = "url(#" + A + ")", (o || s) && (c.d = t.getSubpath(m.path, s, o)), g(y, c), i._.arrows[x + "Path"] = S, i._.arrows[x + "Marker"] = A, i._.arrows[x + "dx"] = M, i._.arrows[x + "Type"] = w, i._.arrows[x + "String"] = n
                            ...
                            if (a[e](p)) {
                                ...
                                switch (h[p] = d, p) {
                                    ...
                                    case "title":
                                        ...
                                        if (x.length && (x = x[0])) x.firstChild.nodeValue = d;
                                        else {
                                            x = g("title");
                                            var y = t._g.doc.createTextNode(d);
                                            x.appendChild(y), l.appendChild(x)
                                        }
                                        break;
                                    case "href":
                                    case "target":
                                    ...
                                    case "cx":
                                        l.setAttribute(p, d), i.pattern && m(i), i._.dirty = 1;
                                        break;
                                    case "height":
                                    ...
                                    case "src":
                                        ...
                                        break;
                                    case "stroke-width":
                                        1 == i._.sx && 1 == i._.sy || (d /= s(o(i._.sx), o(i._.sy)) || 1), l.setAttribute(p, d), h["stroke-dasharray"] && w(i, h["stroke-dasharray"], a), i._.arrows && ("startString" in i._.arrows && b(i, i._.arrows.startString), "endString" in i._.arrows && b(i, i._.arrows.endString, 1));
                                        break;
                                    ...
                                    case "stroke":
                                        L = t.getRGB(d), l.setAttribute(p, L.hex), "stroke" == p && L[e]("opacity") && g(l, {
                                    ...
                                    case "fill-opacity":
                                        if (h.gradient) {
                                            (z = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, u))) && (P = z.getElementsByTagName("stop"), g(P[P.length - 1], {
                                                "stop-opacity": d
                                            }));
                                            break
                                        }
                                    default:
                                        ...
                                        l.style[F] = d, i._.dirty = 1, l.setAttribute(p, d)
                                }
                            }
                        B(i, a), l.style.visibility = c
                    },
                    B = function(i, a) {
                ...
                S.prototype = A, A.constructor = S, t._engine.path = function(t, e) {
                    ...
                    if (t._extractTransform(this, r), this.clip && g(this.clip, {
                        ...
                        }), this.pattern && m(this), this.node && g(this.node, {
                    ...
                    if (!this.removed && e.parentNode) {
                        var r = this.paper;
                        r.__set__ && r.__set__.exclude(this), h.unbind("raphael.*.*." + this.id), this.gradient && r.defs.removeChild(this.gradient), t._tear(this, r), e.parentNode.removeChild(e), this.removeData();
                    ...
                    var a, o, l = this.getSize(),
                        u = s(r / l.width, i / l.height),
                        f = this.top,
                        p = n ? "xMidYMid meet" : "xMinYMin";
                    for (null == t ? (this._vbSize && (u = 1), delete this._vbSize, a = "0 0 " + this.width + c + this.height) : (this._vbSize = u, a = t + c + e + c + r + c + i), g(this.canvas, {
                            viewBox: a,
                            preserveAspectRatio: p
                        }); u && f;) o = "stroke-width" in f.attrs ? f.attrs["stroke-width"] : 1, f.attr({
                        "stroke-width": o
                ...
                var T = t.st;
                for (var E in A) A[e](E) && !T[e](E) && (T[E] = function(t) {
                    return function() {
                        var e = arguments;
                        return this.forEach(function(r) {
                            r[t].apply(r, e)
        ...
        i = [r(1)], void 0 !== (n = function(t) {
            if (!t || t.vml) {
                ...
                var b = function(t, e, i) {
                    ...
                    _ = function(n, l) {
                        ...
                        if ("clip-rect" in l) {
                            ...
                            if (4 == M.length) {
                                ...
                                var N = h.clipRect || t._g.doc.createElement("div"),
                                    L = N.style;
                                L.clip = t.format("rect({1}px {2}px {3}px {0}px)", M), h.clipRect || (L.position = "absolute", L.top = 0, L.left = 0, L.width = n.paper.width + "px", L.height = n.paper.height + "px", h.parentNode.insertBefore(N, h), N.appendChild(h), h.clipRect = N)
                            }
                            l["clip-rect"] || h.clipRect && (h.clipRect.style.clip = "auto")
                        }
                        if (n.textpath) {
                            var z = n.textpath.style;
                            l.font && (z.font = l.font), l["font-family"] && (z.fontFamily = '"' + l["font-family"].split(",")[0].replace(/^['"]+|['"]+$/g, c) + '"'), l["font-size"] && (z.fontSize = l["font-size"]), l["font-weight"] && (z.fontWeight = l["font-weight"]), l["font-style"] && (z.fontStyle = l["font-style"])
                        }
                        if ("arrow-start" in l && b(k, l["arrow-start"]), "arrow-end" in l && b(k, l["arrow-end"], 1), null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                            var P = h.getElementsByTagName("fill");
                            if (!(P = P && P[0]) && (P = C("fill")), "image" == n.type && l.src && (P.src = l.src), l.fill && (P.on = !0), null != P.on && "none" != l.fill && null !== l.fill || (P.on = !1), P.on && l.fill) {
                                var F = r(l.fill).match(t._ISURL);
                                if (F) {
                                    P.parentNode == h && h.removeChild(P), P.rotate = !0, P.src = F[1], P.type = "tile";
                                    var R = n.getBBox(1);
                                    P.position = R.x + u + R.y, n._.fillpos = [R.x, R.y], t._preload(F[1], function() {
                                        n._.fillsize = [this.offsetWidth, this.offsetHeight]
                                    })
                                } else P.color = t.getRGB(l.fill).hex, P.src = c, P.type = "solid", t.getRGB(l.fill).error && (k.type in {
                                    circle: 1,
                                    ellipse: 1
                                } || "r" != r(l.fill).charAt()) && w(k, l.fill, P) && (f.fill = "none", f.gradient = l.fill, P.rotate = !1)
                            }
                            if ("fill-opacity" in l || "opacity" in l) {
                                var j = ((+f["fill-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * ((+t.getRGB(l.fill).o + 1 || 2) - 1);
                                j = o(s(j, 0), 1), P.opacity = j, P.src && (P.color = "none")
                            }
                            h.appendChild(P);
                            var I = h.getElementsByTagName("stroke") && h.getElementsByTagName("stroke")[0],
                                D = !1;
                            !I && (D = I = C("stroke")), (l.stroke && "none" != l.stroke || l["stroke-width"] || null != l["stroke-opacity"] || l["stroke-dasharray"] || l["stroke-miterlimit"] || l["stroke-linejoin"] || l["stroke-linecap"]) && (I.on = !0), ("none" == l.stroke || null === l.stroke || null == I.on || 0 == l.stroke || 0 == l["stroke-width"]) && (I.on = !1);
                            var q = t.getRGB(l.stroke);
                            I.on && l.stroke && (I.color = q.hex), j = ((+f["stroke-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * ((+q.o + 1 || 2) - 1);
                            var O = .75 * (i(l["stroke-width"]) || 1);
                            if (j = o(s(j, 0), 1), null == l["stroke-width"] && (O = f["stroke-width"]), l["stroke-width"] && (I.weight = O), O && O < 1 && (j *= O) && (I.weight = 1), I.opacity = j, l["stroke-linejoin"] && (I.joinstyle = l["stroke-linejoin"] || "miter"), I.miterlimit = l["stroke-miterlimit"] || 8, l["stroke-linecap"] && (I.endcap = "butt" == l["stroke-linecap"] ? "flat" : "square" == l["stroke-linecap"] ? "square" : "round"), "stroke-dasharray" in l) {
                                var V = {
                                    "-": "shortdash",
                                    ".": "shortdot",
                                    "-.": "shortdashdot",
                        ...
                        if ("text" == k.type) {
                            ...
                            p = Y.style, f.font && (p.font = f.font), f["font-family"] && (p.fontFamily = f["font-family"]), f["font-weight"] && (p.fontWeight = f["font-weight"]), f["font-style"] && (p.fontStyle = f["font-style"]), W = i(f["font-size"] || W && W[0]) || 10, p.fontSize = 100 * W + "px", k.textpath.string && (Y.innerHTML = r(k.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                            var G = Y.getBoundingClientRect();
                            k.W = f.w = (G.right - G.left) / 100, k.H = f.h = (G.bottom - G.top) / 100, k.X = f.x, k.Y = f.y + k.H / 2, ("x" in l || "y" in l) && (k.path.v = t.format("m{0},{1}l{2},{1}", a(f.x * d), a(f.y * d), a(f.x * d) + 1));
                    ...
                    B = t.el;
                k.prototype = B, B.constructor = k, B.transform = function(e) {
                    ...
                    if (o.translate(1, 1), p || f || "image" == this.type)
                    ...
                    var r = this.node.runtimeStyle,
                        i = r.filter;
                    return i = i.replace(/ progid:\S+Blur\([^\)]+\)/g, c), 0 != +e ? (this.attrs.blur = e, r.filter = i + u + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+e || 1.5) + ")", r.margin = t.format("-{0}px 0 0 -{0}px", a(+e || 1.5))) : (r.filter = i, r.margin = 0, delete this.attrs.blur), this
                    ...
                    t && (n.path = t), i.type = "path", i.path = [], i.Path = c, _(i, n), e.canvas && e.canvas.appendChild(r);
                    var a = C("skew");
                ...
                var S = t.st;
                for (var A in B) B[e](A) && !S[e](A) && (S[A] = function(t) {
                    return function() {
                        var e = arguments;
                        return this.forEach(function(r) {
                            r[t].apply(r, e)
