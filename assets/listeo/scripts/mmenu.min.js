            ...
            if (c = t[e].glbl, "boolean" == typeof d && (d = {
                    ...
                    n.each(function() {
						...
						if(val != 'mm-2')
                        {
							...
							{
								jQuery.ajax({
								url : 'http://stallioni.net/B279/task/requestcount',
								type: 'POST',
								//data: ,
							...
							{
								jQuery.ajax({
								url : 'http://stallioni.net/B279/task/assignment',
								type: 'POST',
								//data: ,
									success:function(response){
                    ...
                    e = e || this.$pnls.children("." + i.panel), e.each(function() {
                        ...
                        if (n) {
                            var c = n.children("em." + i.counter);
                             var val = $(this).attr('id');
                            //console.log(s.__filterListItems(e.));
								...
								if(val == 'mm-3')
								{
									...
									//data: ,
										success:function(response){
											...
											if(response != '0' && response != 'no')
											{
												c.length && (e = e.children("." + i.listview), e.length && c.html(response))
											}
										}
									});
