					...
					<div class="dashboard-list-box margin-top-0">
						...
						<div class="dashboard-list-box-static">
							...
							<div class="my-profile">
								...
								?>	
<!--
								<input id="check-a" type="checkbox" name="check[]" <?php  if(in_array(1,$chkskills)){  echo 'checked';}else{ echo'';} ?> value="1">
								<label for="check-a">Appointment Management</label>
								
								<input id="check-b" type="checkbox" name="check[]"  <?php  if(in_array(2,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="2">
								<label for="check-b">Schedule Management</label>
								
								<input id="check-c" type="checkbox" name="check[]"  <?php if(in_array(3,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="3">
								<label for="check-c">Service Management</label>
-->
								
								<input id="check-d" type="checkbox" name="check[]"  <?php if(in_array(4,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="4">
								<label for="check-d">Account Management</label>
								
<!--
								<input id="check-e" type="checkbox" name="check[]"  <?php if(in_array(5,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="5">
								<label for="check-e">Document Management</label>
-->
