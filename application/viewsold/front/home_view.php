                        ...
                        <li class="list-group-item featured job-result-item" data-disciplines="corporate-hse">
                           <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_postjoballval->po_id; ?>" class="listing full-time">
                              <div class="listing-title">
                                 <h4><?php echo $get_postjoballval->highleveljobdesc; ?></h4>
                                 <p><?php echo $get_postjoballval->job_description; ?></p>
                                 <ul class="listing-icons">
                                    <li><i class="fa fa-briefcase"></i> <?php echo $get_postjoballval->explevel1; ?></li>
                                    <li><i class="fa fa-address-card" aria-hidden="true"></i> <?php echo $get_postjoballval->joblocation; ?></li>
                                    ...
                                    <li>
                                       ...
                                       <div class="listing-date new">
                                          ...
                                          <p id="demo_<?php echo $get_postjoballval->po_id; ?>" class="demopo" data-demopoid="<?php echo $c_dat; ?>"></p>
                                       </div>
                                       <?php } ?>
                                    </li>
                                 </ul>
                              </div>
                              <?php	if(empty($check_awardedjob)){
                                 if(!empty($check_bidjob) && $check_bidjob->status == 1 ){ ?>
                              <div class="col-xs-6 col-md-3">
                                 <div class="panel status panel-success">
                                    <div class="panel-heading">
                                       <p class="panel-title text-center">Bidded</p>
                                    </div>
                                 </div>
                              </div>
                              <?php } 
                              ...
                              <div class="col-xs-6 col-md-3">
                                 <div class="panel status panel-success">
                                    <div class="panel-heading">
                                       <p class="panel-title text-center">Send proposal</p>
                                    </div>
                                 </div>
                              </div>
                              <?php } 
                              ...
                              <div class="col-xs-6 col-md-3">
                                 <div class="panel status panel-success">
                                    <div class="panel-heading">
                                       <p class="panel-title text-center">Awarderd</p>
                                    </div>
                                 </div>
                              </div>
                              <?php } ?>
