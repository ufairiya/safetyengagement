                                ...
                                <li class="list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_postjoballval->po_id; ?>" class="listing full-time">
                                        <div class="listing-title">
                                            <h4><?php echo  substr($get_postjoballval->highleveljobdesc,0,90).'....'; ?></h4>  <?php  if($get_postjoballval->jobemergency == '1' && $get_postjoballval->job_status != 3 && $get_postjoballval->status != 2){  ?>
                                                    ...
                                                    <?php } else if($get_postjoballval->status == 2 && $get_postjoballval->job_status == 3){?>
														    <div class="pull-right listing-date new">
                                                    <span>Awarded</span>
                                                </div>
