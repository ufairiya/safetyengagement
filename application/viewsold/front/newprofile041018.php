...
<li class="list-group-item featured job-result-item" data-disciplines="corporate-hse">
				  ...
				  <div class="listing-title">
					  <h4><?php echo$get_postjoballval->job_title; ?></h4>
					  <p><?php echo$get_postjoballval->highleveljobdesc; ?></p>
					 
					 
					 <ul class="listing-icons">
						 <li><p><i class="fa fa-briefcase"></i> <?php echo $get_postjoballval->joblocation.' ,'.$get_postjoballval->city.' ,'.$get_postjoballval->state; ?></p>
					</li>
<!--
						 <li><i class="fa fa-briefcase"></i> <?php echo $get_postjoballval->joblocation; ?>,<?php echo $get_postjoballval->city; ?>,<?php echo $get_postjoballval->state; ?></li>
						 <li><i class="fa fa-address-card" aria-hidden="true"></i> <?php echo $get_postjoballval->job_description; ?></li>
						 <li><i class="fa fa-money"></i><?php echo $get_postjoballval->budget; ?></li>
		...
		<li class="list-group-item featured job-result-item" data-disciplines="corporate-hse">
			<a href="#" class="listing full-time">
				<div class="recent-job-list-home">
					<h6> <?php echo $get_postjoballval->highleveljobdesc; ?></h6>
					<p>
					...
					<p> <?php echo $get_postjoballval->joblocation; ?></p>
					<p> <?php echo $get_postjoballval->job_description; ?></p>
					<p> <?php echo $get_postjoballval->jobemergency; ?></p>
					<div class="clearfix"></div>
				</div>
			</a>
		</li>
