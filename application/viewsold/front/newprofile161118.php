							...
							<div class="safeprof col-lg-12 col-md-12" >
								...
								<div class="col-lg-8 col-md-8 spacetopbottom" >
									...
									<div class="control-label ">	
										...
										<div class="col-50"><label for="fname" ><?php //echo $user_information->email; ?></label>
										</div>
									</div>
									<div class="control-label ">	
										...
										<div class="col-50">
											<label for="fname" ><?php   foreach($get_rating as $get_ratingval){   ?>
												<div class="job-head-info">
													...
													<input type="hidden"  class="getcount" name="getcount"  value="<?php if(!empty($get_ratingval->countrating)){  echo $get_ratingval->countrating/$get_ratingval->ra_id; } ?>" />
												</div>
												<?php } ?>
											</label>
										</div>
											...
											<h4>Upload documents and pictures </h4>
											 <div class="col-md-6">
												<div class="form-group">
													...
													<?php if(!empty($user_information->resumeimg_uploadimg_link))
														{
														...
														?>
															<div class="col-md-3">
															<span class="removeimg removeimgres" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" class="removeimg removeimgres" href="<?php echo $base_url.'uploads/'.$pic; ?>"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a></span> </div>
														<?php
														} 
														echo '</div>';
														}
												...
												<div class="form-group">
													...
													<?php 
														...
														?>
														<div class="col-md-3">
														<span class="removeimg removeimgclg" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" href="<?php echo $base_url.'uploads/'.$pic; ?>" class="removeimg removeimgclg"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a>  </span></div> 
														<?php
														}
														echo '</div>'; 
												...
												<div class="form-group">
													...
													<?php 
														...
														?>
													<div class="col-md-3">
															<span class="removeimg removeimgotherdoc" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" href="<?php echo $base_url.'uploads/'.$pic; ?>" class="removeimg removeimgotherdoc"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a>  </span> </div>
														<?php
														} 
														echo '</div">';
										...
										<?php if($this->session->userdata('user_type_fr') == 'professional'){ ?>	
												<div class="form-group">
													...
													<div class="checkboxes col-md-12 float-left in-row margin-bottom-20">
														...
														?>
														<div class="col-md-3">
															<span class="removeimg removeimgavt" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" href="<?php echo $base_url.'uploads/'.$pic; ?>" class="removeimg removeimgavt"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a>  </span> </div>
														<?php
														} 
														echo '</div>';
													...
													<div class="checkboxes col-md-12 float-left in-row margin-bottom-20">
														...
														?>
															<div class="col-md-3">
																<span class="removeimg removeimgisnet" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" href="<?php echo $base_url.'uploads/'.$pic; ?>" class="removeimg removeimgisnet"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a>  </span> </div>
														<?php
														}
														echo '</div>'; 
													...
													<div class="checkboxes col-md-12 in-row margin-bottom-20">
														...
														?>
														<div class="col-md-3">
															<span class="removeimg removeimgbrown" data-imgtest="<?php echo $pic; ?>" ><a target="_blank" href="<?php echo $base_url.'uploads/'.$pic; ?>" class="removeimg removeimgbrown"><i class="fa fa-remove"></i>
														<image src="<?php echo $base_url.'uploads/'.$age_code; ?>" style="width: 75px;" /> </a>  </span> </div>
														<?php
														} 
														echo '</div>';
