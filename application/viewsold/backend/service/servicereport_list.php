				...
				<div class="col-md-12">
					...
					<nav id="breadcrumbs">
						<ul>
							...
							<li><a href="#">Service Sheet Management</a></li>
							<li>View</li>
						</ul>
					</nav>
				</div>
			...
			<div id="invoice">
				...
				<div class="row">
					...
					<div class="col-md-6">	
						...
						<p id="details">
							<strong>Report:</strong> <?php echo $get_service_report_detail->SR_code; ?> <br>
							<strong>Issued:</strong> <?php echo $get_service_report_detail->issueddate; ?>
						</p>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3 sr-prof">
						<p>
							...
							<?php echo $get_service_report_detail->phone; ?><br>
							<?php echo $get_service_report_detail->email; ?><br>
						</p>
						<p>
							<?php echo $get_service_report_detail->apartment; ?><br>
							<?php echo $get_service_report_detail->sr_address; ?>
						</p>
					</div>
					...
					<div class="col-md-3">  
						...
						<?php $contradetails = $this->users_model->gewtcontdetails($get_service_report_detail->contractor_id); ?>
						<strong>Contractor's Company Name</strong>
						<p><?php echo $contradetails->companyname; ?></p>
						<strong>Contractor's Name</strong>
						<p><?php echo $contradetails->username; ?></p>

						<strong>Service Category</strong>
						<p><?php echo $get_service_report_detail->task_catname; ?></p>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12 sr-desc">
						<p><?php echo $get_service_report_detail->txtdescrip; ?>
						<?php 
						if(!empty($get_service_report_detail->additional_description))
						{ 
						?>
							<br><strong class="margin-top-10">Additional Descriptions (optional):</strong>
							<?php echo $get_service_report_detail->additional_description; ?></p>
						<?php
						}
						?>
					</div>
					...
					<div class="col-md-12 sr-desc numbered">
						<ol>
							...
							$price = unserialize($get_service_report_detail->cont_price);
							for($i = 0; $i< count($jobname); $i++)
							{
							?>
								<li><?php echo $jobname[$i]; ?> - $<?php echo $price[$i]; ?></li>
					...
					<div class="col-md-4 signature" >
							<div class="signature-box" style="border-bottom: 1px solid #aaa; ">
								<img src="<?php echo $get_service_report_detail->img_sign; ?>" />
							</div>
						<label><?php echo $get_service_report_detail->witeness_name; ?></label>
					</div>
				</div>
