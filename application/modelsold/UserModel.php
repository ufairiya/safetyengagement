...
class UserModel extends CI_Model {
	...
	{  
		...
		$this->db->from($this->User);
				...
				$this->db->where("id",$this->session->userdata('id_user_master'));
	...
	{  
 		...
 		$this->db->select('id_user_master,profile_image');

		$this->db->from($this->Usermaster);
		...
		if(!empty($res['profile_image'])){
			...
			return base_url('uploads/'.$res['profile_image']);

		}else{

			return base_url('uploads/default17.jpg');

		}

   	}
	public function PictureUrlByIdsenfirstname($id)

	{  

 		$this->db->select('id_user_master,first_name');
	...
	public function PictureUrlByIdsenemail($id)

	{  

 		$this->db->select('id_user_master,email');
	...
	public function PictureUrlByIdrec($id)
	...
	public function PictureUrlByIdrecfirstname($id)
	...
	public function PictureUrlByIdrecemail($id)
