...
class Home extends CI_Controller
	...
	public	function index()
		...
		{
		//	$this->session->set_flashdata('showpopup','login home');
			$get_postjoball = $this->postjob_model->get_postjoball();
			$data['base_url'] = base_url();
			$data['view_file'] = "home_view";
			$data['get_postjoball'] = $get_postjoball;
	...
	public	function thankyou()
		{
			...
			$updateempty = $this->postjob_model->updateemptystatus($this->input->get('cm'),$uptempdata);
	...
	public	function company_profile()
	{
		...
		$data['get_compratingjob'] = $this->users_model->get_compratingjobprofile(array('comid' => $this->session->userdata('id_user_master')));
	// ~ $get_postjoball = $this->postjob_model->get_postmanagejoball($this->session->userdata('id_user_master'));
	...
	public	function sendmail()
		...
		$result = $this->email->from($this->input->post('email'))->reply_to($this->input->post('email'))->to('omaraw1965@gmail.com')->cc('test.stallioni@gmail.com,surya@stallioni.com')->subject($subject)->message($body)->send();
		if ($result == true)
			{
