...
//~ exit;
		...
		//~ exit;
			...
			$postjobdata = array('job_title'=>$this->input->post('job_title'),'highleveljobdesc'=>$this->input->post('highleveljobdesc'),'job_description'=>$this->input->post('job_description'),'equipment'=>$this->input->post('equipment'),'safetyhazards'=>$this->input->post('safetyhazards'),'finalrep'=>$this->input->post('finalrep'),'information'=>$this->input->post('information'),'industry'=>$this->input->post('industry'),'internship'=>$internship,'project'=>$this->input->post('project'),'start_date'=>$this->input->post('start_date'),'end_date'=>$this->input->post('end_date'),'jobemergency'=>$this->input->post('jobemergency'),'worktype_desc'=>json_encode($this->input->post('worktype_desc')),'explevel1'=>$this->input->post('explevel1'),'thirdpartapprov'=>$thirdpartapprov,'thirdpartother'=>$othertxt,'joblocation'=>$this->input->post('joblocation'),'city'=>$this->input->post('city'),'state'=>$this->input->post('state'),'zipcode'=>$this->input->post('zipcode'),'insurance'=>$insurance,'hourorfix'=>$this->input->post('hourorfix'),'budget'=>$this->input->post('budget'),'detailed_pic'=>implode(",",array_filter($detailed_p)),'equipment_pic'=>implode(",",array_filter($equipment_p)),'finalrep_pic'=>implode(",",array_filter($finalrep_p)),'project_pic'=>implode(",",array_filter($project_p)),'certificates_pic'=>implode(",",array_filter($certificates_p)),'insurance_certificate'=>implode(",",array_filter($insurance_c)),'budget_img'=>implode(",",array_filter($budget_p)),'job_file'=>json_encode(explode(",",$this->input->post('files_pic'))),'posteddate'=>date('m/d/Y h:i:s A'),'company_userid'=>$this->session->userdata('id_user_master'),'job_status'=>"2");
