					...
					<div class="dashboard-list-box margin-top-0">
						...
						<div class="dashboard-list-box-static">
							...
							<div class="my-profile">
								...
								<input id="check-g" type="checkbox" name="check[]"  <?php if(in_array(7,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="8">
								<label for="check-g">Post Job Management</label>
															
								<input id="check-g" type="checkbox" name="check[]"  <?php if(in_array(7,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="9">
								<label for="check-g">Bidded Job Management</label>
															
								<input id="check-g" type="checkbox" name="check[]"  <?php if(in_array(7,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="10">
								<label for="check-g">Awarded Job Management</label>
															
								<input id="check-g" type="checkbox" name="check[]"  <?php if(in_array(7,$chkskills)){  echo 'checked';}else{ echo'';}  ?> value="11">
