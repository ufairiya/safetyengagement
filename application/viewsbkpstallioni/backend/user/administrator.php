			...
			<form method="post" name ="addadmin" id="addadmin" >
				...
				<div class="message-reply margin-top-0">
					...
					<div class="checkboxes in-row margin-bottom-20">
						...
						<input id="check-g" type="checkbox" name="check[]" value="8" />
								<label for="check-g">Post Job Management</label>		<br>														
						<input id="check-g" type="checkbox" name="check[]" value="9" />
								<label for="check-g">Bidded Job Management</label>		<br>														
						<input id="check-g" type="checkbox" name="check[]" value="10" />
								<label for="check-g">Awarded Job Management</label>		<br>														
						<input id="check-g" type="checkbox" name="check[]" value="11" />
								<label for="check-g">Completed Job Management</label>														
					</div>
					<div class="error"></div>
...
console.log(answerString);
						...
						var skillapt ='<div class="admin-rights"><input id="check-a" '+($.inArray("1", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-a">Account Management</label></div><div class="admin-rights"><input id="check-f" '+($.inArray("6", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-f">Packages Management</label></div><div class="admin-rights"><input id="check-g" '+($.inArray("7", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-g">Payment Management</label></div><div class="admin-rights"><input id="check-g" '+($.inArray("8", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-g">Post Job Management</label></div><div class="admin-rights"><input id="check-g" '+($.inArray("9", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-g">Bidded Job Management</label></div><div class="admin-rights"><input id="check-g" '+($.inArray("10", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-g">Awarded Job Management</label></div><div class="admin-rights"><input id="check-g" '+($.inArray("11", answerString) !== -1 ? 'checked': '')+' type="checkbox" name="check" disabled><label for="check-g">Completed Job Management</label></div>';
						 }
