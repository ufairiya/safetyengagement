                ...
                <div class="row equalize xs-equalize-auto">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 display-table sm-text-center xs-margin-20px-bottom">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="<?php echo base_url();?>"><img class="footer-logo" src="<?php echo base_url();?>assets/img/logo.jpg" data-at2x="<?php echo base_url();?>assets/img/logo.jpg" alt="stallioni" /></a>
                        </div>
                    </div> 
                    <!-- end logo -->
                    <!-- start copyright -->
                    <div class="col-md-5 col-sm-5 col-xs-12 text-center text-small alt-font display-table xs-margin-10px-bottom">
                        <div class="display-table-cell vertical-align-middle">
                            &copy; 2018 is Proudly Powered by <a href="http://www.stallioni.com" target="_blank" title="stallioni">stallioni</a>.
                        </div>
                    </div>
                    <!-- end copyright -->
                    <!-- start social media -->
