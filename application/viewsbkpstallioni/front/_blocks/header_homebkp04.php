...
<html lang="en">
   <head>
      ...
      <!-- title -->
      <title>Stallioni – Web portal for the Safety Professionals and Companies.</title>
      <meta charset="utf-8" />
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1" />
      <meta name="author" content="ThemeZaa" />
      <!-- description -->
      <meta name="description" content="stallioni – Web portal for the Safety Professionals and Companies. The site will act as a platform enabling both the actors fulfill each others requirements." />
      <!-- keywords -->
      <meta name="keywords" content="Web portal, Safety, Professionals, Companies, Safety Professional, Safety Professionals, platform, requirements, stallioni" />
      <!-- favicon -->
                  ...
                  <div class="row">
                     <div class="stl_head">
                        <div class="col-md-2  col-xs-10">
                           <a href="<?php echo base_url();?>" title="stallioni" class="logo"><img src="<?php echo base_url();?>assets/img/logo.jpg" data-at2x="<?php echo base_url();?>assets/img/logo.jpg" class="logo-dark" alt="stallioni" /><img src="<?php echo base_url();?>assets/img/logo.jpg" data-at2x="<?php echo base_url();?>assets/img/logo.jpg" alt="stallioni" class="logo-light default" /></a>
                        </div>
                              ...
                              <div class="">
                                 ...
                                 { 
									...
									<div class="dropdown" id="apddropdown">
										<div style="margin:45px 0 0 15px"  id="badgecountid"> <i  onclick="myFunction()" class="dropbtn fa fa-bell" aria-hidden="true"></i>
												...
												{ //echo $count_inboxs->poid;
													...
													<?php if($this->session->userdata('user_type_fr') == 'company'){ ?>
														...
														<?php if(!empty($getsenderdetails->profile_image)){ ?> 
														 ...
														 <?php } else { ?> 
															 <img src="https://stallioni.net/B289a/uploads/default17.jpg" class="img-responsive" style="width: 40px;height: 40px;border-radius: 25px;border: 1px solid rgba(0,0,0,0.1);">
														<?php } ?>
														 </div>
														 <div class="col-md-9 col-sm-9 col-xs-9">
														<p><?php echo '<b>'.$getsenderdetails->first_name.'</b> sent to message'; ?> <br>
														<span><?php echo '<i><b>'.$count_inboxs->message.'</b></i>'; ?></span>
														</p>
														</div>
													</a>
													<?php } else { ?>
