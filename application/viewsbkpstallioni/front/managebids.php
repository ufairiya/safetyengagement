							 ...
							 { ?> 
                              <ul class="dashboard-list-box list-groupaccons list-group">
                                 ...
                                 <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                          <h4 class="pull-left sell__section__row__title"><a href="#" ><?php if(!empty($get_completed_post->highleveljobdesc)){ echo $get_completed_post->highleveljobdesc; } ?></a></h4>
<!--
...
-->
                                       ...
                                       <div class="clear"></div>
                                       <label><?php if(!empty($get_completed_post->job_description)){ echo $get_completed_post->job_description; } ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php if(!empty($get_completed_post->joblocation) && !empty($get_completed_post->city) && !empty($get_completed_post->state)){  echo $get_completed_post->joblocation.' ,'.$get_completed_post->city.' ,'.$get_completed_post->state; } ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-building"></i> &nbsp;&nbsp;<span></span></div>
