									...
									<div class="tab-content">
										<div id="information" class="tab-pane active">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													<label class="control-label">A new job notification</label>
													<input id="checkon1" type="radio" <?php if($user_information->notifionoff == 'on'){  echo 'checked="checked"'; } ?> name="notifionoff"  value="on" /><label for="checkon1">ON</label>
ON	
													<input id="checkoff2" type="radio" <?php if($user_information->notifionoff == 'off'){  echo 'checked="checked"'; } ?> name="notifionoff"  value="off" /><label for="checkoff2">OFF</label>
												</div>
											</div>
											<div class="col-md-6">
                                  ...
                                  <div id="subpro" class="active" style="display: block;">
                                    ...
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                          <h4 class="pull-left sell__section__row__title"><a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_submitpost->po_id; ?>" ><?php echo $get_submitpost->job_title; ?></a></h4>
<!--
...
-->
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo $get_submitpost->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_submitpost->city.' ,'.$get_submitpost->state; ?></span></div>
                                    ...
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                          <h4 class="pull-left sell__section__row__title">
                                             <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_award_post->po_id; ?>" title="I need dot training next week"><?php echo $get_award_post->job_title; ?></a>
                                          </h4>
<!--
...
-->
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo $get_award_post->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                             ...
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_award_post->city.' ,'.$get_award_post->state; ?></span>
                                             </div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-building"></i> &nbsp;&nbsp;<span></span></div>
                                          </div>
                                          <div class="sell__section__row__list__child">
							 ...
							 { ?> 
                              <ul class="dashboard-list-box list-groupaccons list-group">
                                 ...
                                 <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                          <h4 class="pull-left sell__section__row__title"><a href="#" title="I need dot training next week"><?php echo $get_completed_post->job_title; ?></a></h4>
<!--
...
-->
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo$get_completed_post->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_completed_post->city.' ,'.$get_completed_post->state; ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-building"></i> &nbsp;&nbsp;<span></span></div>
