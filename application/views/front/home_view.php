                                   ...
                                   <div class="form-wrap">
                                       ...
                                       <div id="findjob" class="tab-contenthome current">
                                          ...
                                          <input type="text" id="hbz-input" class="col-lg-8 col-md-12 col-sm-12" name="finddata" placeholder="ENTER ZIP CODE, INDUSTRY, STATE BELOW OR TYPE ANY" /> 
                                             <button id="hbz-submit" class="col-lg-4 col-md-12 col-sm-12" type="submit">Find Job</button>  
                                             
                                             
                                               <input type="hidden" name="max-results" value="8" />
                                                <div class="finddatasearch">
                                           <div class="col-lg-12 col-md-12 col-sm-12" style="text-align: left;"> <input type="checkbox" class="chkintern" id="hbz-input" name="finddata"/><span class="txtintern">Internship</span>    </div></div>  
