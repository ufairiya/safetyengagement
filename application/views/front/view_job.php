				 	...
				 	<div class="col-lg-8 column jobdetailslt">
				 		<div class="job-single-sec">
				 			<div class="job-single-head">
				 				<div class="job-thumb"> <img src="<?php echo $base_url; ?>assets/images/companyshadow.png" alt="" style="width:100px"> </div>
...
-->
				 		<div class="job-overview">
							...
							?></span></li>
				 				...
				 				<li><h3><i class="fa fa-industry"></i>Industry</h3><span><?php echo $getcompanypostdata->industryname; ?></span></li>
				 				<li><h3><i class="fa fa-child"></i></i>Internship</h3><span><?php  if(!empty($getcompanypostdata->internship)){ echo "Yes"; }else{ echo "No"; } ?></span></li>
