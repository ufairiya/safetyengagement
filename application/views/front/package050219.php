...
?>
		 ...
		 ?>
			<div class="col-md-12 ">
         <?php 	$get_checkfree  = $this->packages_model->get_checkfree_package();
				foreach($get_packages_list as $get_postjoballval)
    			{  
					//echo "<pre>";	
							//	var_dump($get_checkfree);
							
			if(!empty($get_checkfree) && $get_postjoballval->pkg_amt == 0)
			{	
					if($get_postjoballval->pkg_amt != 0){ ?>
