		                        ...
		                        <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                         <h4 class="pull-left sell__section__row__title"> <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_postjoballval->po_id; ?>" ><?php echo $get_postjoballval->job_title; ?></a></h4>  
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo$get_postjoballval->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_postjoballval->city.' ,'.$get_postjoballval->state; ?></span></div>
                                 ...
                                 <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                          ...
                                          <h4 class="pull-left sell__section__row__title"> <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_postjoballpaiddata->po_id; ?>" ><?php echo $get_postjoballpaiddata->job_title; ?></a></h4>
<!--
...
-->
                                          <p class=" pull-right sell__section__row__text"><?php if(!empty( $get_postjoballpaiddata->budget)){ echo '$'.$get_postjoballpaiddata->budget; ?><span class="sell__section__row__span">(<?php echo $get_postjoballpaiddata->hourorfix.'price';  ?> )</span> <?php } else{ echo "To be negotiated"; } ?></p>
											 ...
											 <?php 	
												...
												if($get_postjoballpaiddata->jobemergency == 1 ){  ?>
                                                    <div class="listing-date new ">
														<?php 
															$date=date_create($get_postjoballpaiddata->posteddate);
															date_add($date,date_interval_create_from_date_string("2 days"));
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo $get_postjoballpaiddata->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php //echo $get_postjoballval->start_date; 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_postjoballpaiddata->city.' ,'.$get_postjoballpaiddata->state; ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-building"></i> &nbsp;&nbsp;<span></span></div>
                              ...
                              <ul class="dashboard-list-box list-groupactcint list-group">
                                 <?php foreach($get_postawardedtable as $get_postawardedtableval)
                                    { 		
										...
										//~ echo "<pre>";
										//~ var_dump($get_postdataaward);
										
                                    ?>
                                 <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       <div class="sell__section__row__list">
                                         <h4 class="pull-left sell__section__row__title"> <a href="<?php echo $base_url; ?>bids/select_job/<?php echo $get_postdataaward->po_id; ?>" ><?php echo $get_postdataaward->job_title; ?></a></h4>	 
                                           ...
                                           <p class=" pull-right sell__section__row__text"><?php if(!empty( $get_postdataaward->budget)){ echo '$'.$get_postdataaward->budget; ?><span class="sell__section__row__span">(<?php echo $get_postdataaward->hourorfix.'price';  ?> )</span> <?php } else{ echo "To be negotiated"; } ?></p>
											<?php    
											  if($get_postawardedtableval->status == 2)
                                          {
                                          ?>
                                         <span class="pull-right">
                                                    <div class="listing-date new ">
...
<!--
                                                    	<div class="listing-date new ">
														<?php 
															$date=date_create($get_postdataaward->posteddate);
															date_add($date,date_interval_create_from_date_string("21 days"));
															$c_dat = date_format($date,"M d, Y H:i:s A");
															?>
                                                        <span class="fa fa-clock-o"></span>
                                                        <span class="demo_<?php echo $get_postdataaward->po_id; ?>" class="demopo" data-demopoid="<?php echo $c_dat; ?>"></span>
                                                    </div>
-->
                                                  </span>
                                                  <?php }else{  ?>
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo $get_postdataaward->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                          <div class=" sell__section__row__list__child">
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-clock-o"></i><span>	<?php 
                                                ...
                                                ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-map-marker"></i><span><?php echo $get_postdataaward->city.' ,'.$get_postdataaward->state; ?></span></div>
                                             <div class="sell__section__row__list__child__note"><i class="fa fa-building"></i> &nbsp;&nbsp;<span></span></div>
                                             <div class="sell__section__row__list__child__note"></div>
                                             <div class="sell__section__row__list__child__note rulehover">
                                                <div class="number-of-freelancer">
                                                   <?php $get_postprosaldetails = $this->postjob_model->get_post_award_p($get_postawardedtableval->proposproj_id); 
                                                   $get_post_award_sentoffer = $this->postjob_model->get_post_award_sentoffer($get_postawardedtableval->proposproj_id); 
                                                   //~ echo "<pre>";
                                                   //~ var_dump($get_post_award_sentoffer);
                                                   ?>
                                                   <i class="fa fa-dot-circle-o"></i><span class="headtitbid propossub">Submitted Proposals </span>
                                                   <p class="headtitbid fa fa-chevron-down"></p>
                                                   <div class="freelancer-totle-area" >
                                                      <ul>
														<?php $e=0;    foreach($get_postprosaldetails as $get_postproposalsdata ){  
															
															
													
														
																 	if($get_postproposalsdata->prostatus == 2 && $get_postproposalsdata->proposproj_id == $get_postawardedtableval->proposproj_id){
																		if( $e < 1 ){
															 ?>    <li>
                                                            <div class="perposal-img-client" >
                                                               <?php if($get_postproposalsdata->profile_image == ""){ ?><img  style="width: 30px;" src="<?php echo $base_url.'assets/img/default_avatar.png'?>" alt=""><?php } else{ ?><img style="width: 30px;" src="<?php echo $base_url.'uploads/'.$get_postproposalsdata->profile_image; ?>" alt=""><?php } ?>
...
-->
															 ...
															 foreach($get_post_award_sentoffer as $get_post_award_sentofferdata ){  
															  if( $get_post_award_sentofferdata->proposproj_id == $get_postawardedtableval->proposproj_id) {
...
<!--
                                                                <a href="<?php echo $base_url; ?>job/listofACT/<?php echo $get_postdataaward->po_id; ?>">  
-->
                                                                <a href="<?php echo $base_url; ?>home/profile/<?php echo $get_post_award_sentofferdata->id_user_master.'/'.$get_postdataaward->po_id; ?>">                                                     
                                                                <?php 
                                                                echo $get_post_award_sentofferdata->first_name; 
                                                               //~ $get_rating  = $this->postjob_model->get_rating($get_postproposalsdata->id_user_master);
                                                               
                                                                $arrrating = array('comid'=> $this->session->userdata('id_user_master'),'userid'=> $get_post_award_sentofferdata->id_user_master);
                                                               $get_rating  = $this->postjob_model->get_rating($arrrating);
                                                                $get_rat =$get_rating[0];?>  </a>
                                                                <div class="">
																<?php 
                              ...
                              <ul class="dashboard-list-box list-groupcompl list-group">
                                 ...
                                 <li class="col-md-12 list-group-item featured job-result-item" data-disciplines="corporate-hse">
                                    <section class="sell__section__row">
                                       ...
                                       <div class="sell__section__row__list">
                                        <h4 class="pull-left sell__section__row__title"> <a href="<?php echo $base_url; ?>job/complete_job/<?php echo $get_postdatacomplets->po_id; ?>" > <?php echo $get_postdatacomplets->job_title; ?></a> </h4>  
<!--
...
-->
                                       ...
                                       <div class="clear"></div>
                                       <label><?php echo $get_postdatacomplets->highleveljobdesc; ?></label>
                                       <div class=" sell__section__row__list">
                                             ...
                                             <div class="sell__section__row__list__child__note">
												 <i class="fa fa-map-marker"></i><span><?php echo $get_postdatacomplets->city.' ,'.$get_postdatacomplets->state; ?></span></div>
