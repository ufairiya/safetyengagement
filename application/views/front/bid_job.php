            ...
            <div class="col-lg-8 column jobdetailslt">
               <div class="job-single-sec">
                  ...
                  <div class="job-details">
                     ...
                     <p><?php echo $post_detail->job_title;  ?></p>
                     ...
                     <p> <?php echo $worktype_descval;  ?>	</p>
                     <?php } } ?>	
                     <h3>Detailed Job Description (what is the task and what deliverables do you require)</h3>
            ...
            <div class="col-lg-4 column jobdetailsrt">
               ...
               <div class="display-td" >
                  ...
                  <table border="0" cellpadding="10" cellspacing="0" align="center">
                     ...
                     <tr>
                        <td align="center"><a href="" title="How PayPal Works" ><img src="<?php echo $base_url; ?>assets/images/logo-center-solution-graphics.png" border="0" alt="PayPal Acceptance Mark"></a></td>
                     </tr>
                  </table>
                  <!-- PayPal Logo -->
                  <div class="col-md-12">
