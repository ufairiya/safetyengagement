...
<!--
                     <div class="control-label ">	
										...
										<div class="col-50">
											...
											<label for="fname" ><?php if(!empty($get_compratingjob)){ $max = 0; $n = count($get_compratingjob); foreach ($get_compratingjob as $rate => $count) { 
...
//~ echo '<p>Total Rating '.count($get_compratingjob).' people';	

 } else{ ?><input type="hidden"  class="getcount" name="getcount"  value="" /><?php echo '<p>Rating of 0 / 5) stars';
