                     ...
                     <div class="stl_head">
                        ...
                        <div class="col-md-6 col-xs-2 accordion-menu xs-no-padding-right">
                           <!--
                              ...
                              -->
                           <a id="nav_btn" class="i_bar" style="color:#ED7D31;" data-target="#navbar-collapse-toggle-1" data-toggle="collapse"  ><span class="spanclass"></span></a>
                        ...
                        <div class="col-md-4 col-xs-5">
                           <div class="header-searchbar pull-right">
                              ...
                              <div style="float: left;margin: 38px 0 0 22px;"><a class="badgeredirect"><i class="fa fa-bell" aria-hidden="true"></i><span class="badge"><?php echo   $count_inbox; ?></span></a> </div>
                  ...
                  <div class="tab-content" id="tab2" style="display: none;">
                     <div class="">
                        ...
                        <div id="tab-2" class="tab-contentsfcom"  >
                           <span class="notificmsg"></span>
                           <form method="post" id="FormIdsf" name="FormIdsf" style="display:table;">
                              <?php //echo "fgd"; ?>
                              <div class="col-md-6" >
                                 <div class="field-form form-group has-error">	
                                    <label for="Name">First Name:					 								
                                 ...
                                 <div class="field-form form-group has-error">	
                                    <label for="Name">Email Address:					 								
                                    <i class="im im-icon-Email" aria-hidden="true"></i>
                                    <input type="email" placeholder="" name="sfemail" id="sfemail" class="effect-16 mob_textbox" value="" autocomplete="off">
                                    </label>
                                    <span class="focus-border"></span>
                                 </div>
                                 <div class="field-form form-group has-error">	
                                    <label for="Name">Password:					 								
                                    <i class="im im-icon-Mail-Password" aria-hidden="true"></i>
                                    <input type="password" placeholder="" name="password" id="password" class="effect-16 mob_textbox" value="" autocomplete="off">
                                    </label><span class="focus-border"></span>
                                 </div>
                              </div>
                              <div class="col-md-6">
                              ...
                              <div class="col-lg-12">
                                 <button type="submit" class="space_btn button border" id="submit_reg_sf">Register</button>
                              </div>
                           </form>
                        </div>
                     </div>
