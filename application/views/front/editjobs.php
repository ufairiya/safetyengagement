      ...
      <form id="updatepost_a_job" action="<?php echo $base_url?>job/update_post_job" name="post_a_job" enctype="multipart/form-data" method="POST" >
         <div class="job-form__box">
            <div class="job-form__list">
               ...
               <textarea rows="4" cols="50" name="highleveljobdesc" id="highleveljobdesc" class="job-form__list__textarea" placeholder=""><?php echo $edit_postjobs->highleveljobdesc; ?></textarea>
       ...
       <input type="text"  class="job-form__list__input field" name="postal_code" id="postal_code" value="<?php echo $edit_postjobs->zipcode; ?>" />   
               ...
               <select name="se_industry" id="industry" class="industrysel job-form__list__select">
						 ...
						 {   ?>
							 ...
							 <option <?php if(strtolower($get_industry->industry_name) == strtolower($edit_postjobs->industryname)){ echo "selected='selected'"; } ?>  value="<?php echo $get_industry->industry_name ; ?>"><?php echo $get_industry->industry_name ; ?></option>
						 <?php
						 }
						 ?>
                     ...
                     <input type="text" id="industryinp"  name="industry" class="job-form__list__input job-form__budget__input valid industryinp" style="display:none; width:90%" /><span id="removeindustry" class="removeindustry" style="display:none; color: #000">X</span>
                  </div>
                  <div class="job-form__list__box1">
...
<script type="text/javascript">
   ...
   submitHandler: function(form) {
     // form.submit();
		...
		toastr.success("Successfully edit publish.");	
...
<script type='text/javascript'>
   ...
   $('#industry').change(function() {
	   var dataind = '<?php $edit_postjobs->industry ?>';
    if($(this).val() == dataind)
    {
        $('.removeindustry').show();
        $('.industryinp').show();
