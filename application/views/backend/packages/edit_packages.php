<div class="dashboard-content">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-md-12 padding-right-30 margin-bottom-30">
			<div class="dashboard-list-box margin-top-0">
				<h4 class="gray">Update Packages                                 <a href="<?php echo $base_url.'admin/packages'; ?>" class="pull-right button gray"><i class="sl sl-icon-plus"></i> ADD</a>
</h4>
					...
					<div class="my-profile">
                    	<form name="add-package-frm" action="<?php echo $base_url.'admin/packages/update_package_admin';?>" method="POST">
                            ...
                            <select name="package_month_count" id="package_month_count" class="col-md-6" required>
                             ...
                             ?>
                            <input type="number" required  placeholder="count" name="pkg_count" value="<?php echo $get_packages_pkgid->pkg_count; ?>"/>
                             <label>Amount*</label>
