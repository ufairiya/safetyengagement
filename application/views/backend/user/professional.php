...
-->
							...
							<!-- Service Content -->
								<div id="endorse-list">
									<?php //include('inc/users/userlist.php'); ?>
											<?php foreach($list_of_users as $list_of_users_det){ if($list_of_users_det->user_type == 'professional') { ?> 
			...
			<div class="col-lg-6 col-md-12">
				...
				<a href="<?php echo $base_url; ?>admin/user/updateuser" class="btndesign schedule-submit button grey">Update User</a>			
<!--
